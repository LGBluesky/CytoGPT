...
def parse_args():
    ...
    parser.add_argument("--image-root", default='/mnt/disk1/liushijie/Process/Data/Public/LDCC/TrainingSet/Sample/aug', help="specify the root of all images")
...
def check_keyword(a, category, cls_flg=2):
    ...
    if cls_flg ==2:
        cls_mapping = {'nilm': 0, 'negative':0,'positive':1, 'hsil': 1, 'lsil': 1, 'ascus': 1, 'asch': 1, 'unknown': 2, 'sil':1,'asc':1}
    else:
