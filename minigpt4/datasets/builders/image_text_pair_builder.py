...
from minigpt4.datasets.datasets.cyto_caption_dataset import CytoCapDataset, CytoCapEvalDataset
from minigpt4.datasets.datasets.cyto_vqa_dataset import  CytoVQADataset, CytoMultiVQADataset
from minigpt4.datasets.datasets.cyto_conversation import  CytoConversationDataset


@registry.register_builder("cyto_caption")
class CytoCapBuilder(BaseDatasetBuilder):
    train_dataset_cls = CytoCapDataset
    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/cyto/cyto_caption.yaml",
    }
@registry.register_builder("cyto_vqa")
class CytoVQABuilder(BaseDatasetBuilder):
    train_dataset_cls = CytoVQADataset
    eval_dataset_cls = CytoVQADataset
    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/cyto/cyto_vqa.yaml",
    }

@registry.register_builder("cyto_multi_vqa")
class CytoMultiVQABuilder(BaseDatasetBuilder):
    train_dataset_cls = CytoMultiVQADataset
    eval_dataset_cls = CytoMultiVQADataset
    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/cyto/cyto_multi_vqa.yaml",
    }
...
@registry.register_builder("cyto_conversation")
class CytoReasonBuilder(BaseDatasetBuilder):
    train_dataset_cls = CytoConversationDataset
    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/cyto/cyto_conversation.yaml",
    }
